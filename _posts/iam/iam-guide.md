...
{: .mx-auto.d-block :}
**Identity and Access Management components diagram**{:style="display:block; margin-left:auto; margin-right:auto; text-align: center"}
...
In many organizations, this takes the form of systems like Microsoft's Active Directory (AD). Without a central directory, you'd be forced to manage user accounts separately across every application, which is a chaotic and insecure scenario.
