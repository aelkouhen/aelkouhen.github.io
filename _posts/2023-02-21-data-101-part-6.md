...
```
redis-di deploy --rdi-host redis-12500.cluster.redis-ingest.demo.redislabs.com --rdi-port 12500 --rdi-password rdi-password
```
...
```properties
debezium.sink.redis.address=redis-12500.cluster.redis-ingest.demo.redislabs.com
