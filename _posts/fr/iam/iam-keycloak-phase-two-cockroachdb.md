...
Essentiellement, cette couche est le plan de contrôle qui régit la façon dont les clusters sous-jacents et les instances d'identité sont créés, maintenus et intégrés. Ce plan de contrôle simplifie le déploiement et la gestion qui nécessiteraient autrement des connaissances DevOps et une gestion des releases.
