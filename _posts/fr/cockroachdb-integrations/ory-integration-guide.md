...
Ory Keto fournit un contrôle d'accès basé sur les relations (ReBAC) scalable via des tuples de relations, selon le même modèle utilisé par [Google Zanzibar](https://research.google/pubs/pub48190/).
