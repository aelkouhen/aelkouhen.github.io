...
tags: [data formatting,data lineage,normalization,data preparation,data quality,data cleaning,denormalization,join types,data discovery,data transformation,data modeling,normal forms,kimball,data vault,SCD]
comments: true
---
...
*   https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.715.9705&rep=rep1&type=pdf
