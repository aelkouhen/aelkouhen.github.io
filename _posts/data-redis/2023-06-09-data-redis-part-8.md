...
subtitle:  Customer Satisfaction Monitoring using Redis & GCP
thumbnail-img: 
...
tags: [BERT,Customer Satisfaction,embeddings,Emotion Analysis,Google Cloud,Hugging Face,neural networks,NLP,Percentile,PubSub,redis,RedisBloom,RedisJSON,RedisTimeSeries,Sentiment Analysis,Speech-to-Text,t-digest,top-k,Transformers]
comments: true
---
